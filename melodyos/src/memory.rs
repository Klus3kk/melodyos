...
/// Maps the given page to the frame specified by the given physical address,
/// creating page table entries as needed.
pub fn map_page(
    page: Page,
...
/// Print memory information provided by the bootloader
pub fn print_memory_info(memory_map: &'static MemoryMap) {
    println!("Memory map:");
